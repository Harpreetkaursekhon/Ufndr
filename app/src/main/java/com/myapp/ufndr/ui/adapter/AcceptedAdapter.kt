...
class AcceptedAdapter: RecyclerView.Adapter<AcceptedAdapter.ViewHolder>() {
    private var imglike= intArrayOf(R.mipmap.ic_close_icon, R.mipmap.ic_close_icon, R.mipmap.ic_close_icon)
    private var imgclose= intArrayOf(R.mipmap.ic_msg_deselected_icon, R.mipmap.ic_msg_deselected_icon, R.mipmap.ic_msg_deselected_icon)
